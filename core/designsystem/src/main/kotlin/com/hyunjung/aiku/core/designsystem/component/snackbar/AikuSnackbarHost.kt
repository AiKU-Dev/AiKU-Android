...
private const val a11yPaneTitle = "Snackbar"

private val FastSpatial: AnimationSpec<Float>
    get() = tween(
        durationMillis = 150,
        easing = FastOutSlowInEasing
    )

private val FastEffects: AnimationSpec<Float>
    get() = tween(
        durationMillis = 100,
...
@Composable
fun AikuSnackbarHost(
    hostState: AikuSnackbarHostState,
    modifier: Modifier = Modifier,
    snackbar: @Composable (SnackbarData) -> Unit = { AikuSnackbar(it.visuals.message) }
) {
